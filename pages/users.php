            ...
            <?php
                ...
                foreach ($users as $user) {
                    if (!strpos($user['username'], "svc")) {
                        ...
                        echo "<td class=\"user-check\"><input type=\"checkbox\" name=\"user_id\" class=\"is-admin\" value=\"" . $user['id'] . "\"$adminCheck></td>\n";
                        echo "<td class=\"user-check\"><input type=\"checkbox\" name=\"user_id\" class=\"is-supervisor\" value=\"" . $user['id'] . "\"$supCheck></td>\n";
                        echo "<td class=\"user-check\"><input type=\"checkbox\" name=\"user_id\" class=\"is-tech\" value=\"" . $user['id'] . "\"$techCheck></td>\n";
                        echo "<td class=\"user-check\"><input type=\"checkbox\" name=\"user_id\" class=\"cantor-mode\" value=\"" . $user['id'] . "\"$cantorMode></td>\n";
                        echo "</tr>\n";
                    }
                }
            ?>
